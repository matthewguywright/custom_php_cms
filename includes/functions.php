<?php
	...
	function get_all_subjects($public = true) {
		...
		$subject_set = mysql_query($query, $dbconnect);
		...
		$page_set = mysql_query($query, $dbconnect);
	...
	function get_subject_by_id($subject_id) {
		...
		$result_set = mysql_query($query, $dbconnect);
		//confirm_query($result_set);
		$subject = mysql_fetch_array($result_set);
		//IF NO ROWS RETURNED, FETCH RETURNS FALSE
		if ($subject) {
			return $subject;
		} else {
			return NULL;
